...
document.getElementById('mobile-menu-btn').addEventListener("click", function() {
    if (document.getElementById('mobile-menu-btn').classList.contains('close')) {
        document.getElementById('mobile-menu-btn').classList.remove('close');
        document.getElementById('menu-wrapper').classList.remove('active');
        document.getElementById('main-nav').classList.remove('menu-active');
    } else {
        document.getElementById('mobile-menu-btn').classList.add('close');
        document.getElementById('menu-wrapper').classList.add('active');
        document.getElementById('main-nav').classList.add('menu-active');
    }
});
